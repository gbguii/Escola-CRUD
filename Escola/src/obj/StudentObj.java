...
public class StudentObj extends BasicObj{
	 ...
	 * @param lastName		último nome do aluno.
	...
	/**
	 * Retorna o último nome do aluno.
	 * @return o último nome do aluno.
	 */
	...
	/**
	 * Define o último nome do aluno.
	 * @param lastName o último nome do aluno.
	 */
